...
def two_circles():
    ...
    circle2 = rg.Circle(rg.Point(400, 400), 50)
...
def circle_and_rectangle():
    ...
    print('Point (', (p3.x+p2.x)/2, ',', (p3.y+p2.y)/2, ').')
    print((p3.x+p2.x)/2)
    print((p3.y+p2.y)/2)
    #"""
    #-- Constructs an rg.RoseWindow.
...
def lines():
    window = rg.RoseWindow(500, 500)
    line1=rg.Line(rg.Point(50,50),rg.Point(450,450))
    line1.thickness =5
    line1.attach_to(window)
    line2=rg.Line(rg.Point(50,450),rg.Point(450,50))
