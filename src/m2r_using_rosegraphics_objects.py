...
#                attach_to and clone and move_by
#
...
#        necessary?  Why?
#            when you want to be able to look at the window for any amount of time and click through various windows so you can see the window for longer than a split second
#
